...
MODEL_DIR = os.path.join(os.path.dirname(os.path.dirname(__file__)), "storage", "ascan", "models")           # 模型保存目录
...
REPORT_DIR = os.path.join(os.path.dirname(os.path.dirname(__file__)), "storage", "reports")
